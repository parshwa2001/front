                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 xl:grid-cols-4 gap-5 mb-5">
                    <div className="panel">
                        <div className="flex items-center justify-between mb-5">
                            ...
                            <Link to="/users/RouteBorder" className="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                                <IconPencilPaper />
                            </Link>
                            <Link to="/users/UpdateDocuments" className="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                                <IconPencilPaper />
                            </Link>
                            <Link to="/users/Customers" className="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                                <IconPencilPaper />
                            </Link>
                            <Link to="/users/Client" className="ltr:ml-auto rtl:mr-auto btn btn-primary p-2 rounded-full">
                                <IconPencilPaper />
                            </Link>
                        ...
                        <div className="mb-5">
                            <div className="flex flex-col justify-center items-center">
                                ...
                                <p className="font-semibold text-primary text-xl">{user?.contact_person_full_name} </p>
                            </div>
