...
const Country = () => {
    ...
    const saveUser = async () => {
        ...
        if (params.client_id) {
            ...
            // console.log(update);
            const update = await axios.put(`${config.API_BASE_URL}/location/countries/${params.client_id}`, params);
            ...
            let data = await axios.post(`${config.API_BASE_URL}/location/countries`, params);
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.client ? 'Edit Tracking' : 'Add Country'}
                                    </div>
                                    <div className="p-5">
