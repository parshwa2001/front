                        ...
                        <table className="table-striped table-hover">
                            ...
                            <tbody>
                                {filteredItems.map((contact: any) => {
                                    return (
                                        <tr key={contact.id}>
                                            <td className="whitespace-nowrap">{contact.city_id}</td>
                                            <td className="whitespace-nowrap">{contact.state?.country.country_name}</td>
                                            <td className="whitespace-nowrap">{contact.state?.state_name}</td>
                                            <td className="whitespace-nowrap">{contact.city_name}</td>
                                            <td>
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.client ? 'Edit Tracking' : 'Add City'}
                                    </div>
                                    <div className="p-5">
                                        <form onSubmit={formik.handleSubmit}>
                                            <div>
                                                <label htmlFor="ctnSelect4">Select Country</label>
                                                <select
                                                    id="ctnSelect4"
                                                    name="country_id"
                                                    onChange={(e) => {
                                                        ...
                                                        console.log(filterState, 'setfilterStatesetfilterStatesetfilterState');
                                                    }}
                                            ...
                                            <div className="mt-4">
                                                ...
                                                {formik.touched.state_id && formik.errors.state_id && <div className="text-red-500 text-sm">{formik.errors.state_id}</div>}
                                            </div>
                                            <div className="mt-4">
                                                <label htmlFor="countryname">City Name</label>
                                                <input
                                                    id="countryname"
                                                    type="text"
                                                    name="city_name"
                                                    ...
                                                    required
                                                />
                                                {formik.touched.city_name && formik.errors.city_name && <div className="text-red-500 text-sm">{formik.errors.city_name}</div>}
                                            </div>
