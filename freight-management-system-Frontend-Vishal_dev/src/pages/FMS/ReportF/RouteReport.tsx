                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.client ? 'Edit Report' : 'Route Wise Report'}
                                    </div>
                                    <div className="p-5">
                                        <form>
                                            ...
                                            <div className="mt-4">
                                                <div>
                                                    ...
                                                    <select name="route" onChange={(e) => changeValue(e)} value={params.route} className="form-select text-white-dark" required>
                                                        <option value="">Select Route</option>
                                                        <option value="origin">r1</option>
                                                        <option value="destination">r2</option>
                                                    </select>
                                                </div>
                                            </div>
