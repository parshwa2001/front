    ...
    return (
        <div>
            <div className="flex items-center justify-between flex-wrap gap-4">
                <h2 className="text-xl">Driver Booking Report</h2>
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.client ? 'Edit Report' : 'Driver Booking Report'}
                                    </div>
                                    <div className="p-5">
                                        <form>
                                        <div>
                                            ...
                                            <div className="mt-4">
                                                ...
                                                <div>
                                                    ...
                                                    <select name="customer" onChange={(e) => changeValue(e)} value={params.customer} className="form-select text-white-dark" required>
                                                        ...
                                                        <option value="origin">d1</option>
                                                        <option value="destination">d2</option>
                                                    </select>
                                                </div>
                                            </div>
...
export default DriverBookingReport;
