                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.client ? 'Edit Tracking' : 'Add Email Setup'}
                                    </div>
                                    <div className="p-5">
                                        <form onSubmit={formik.handleSubmit}>
                                            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        name="Protocol"
                                                    />
                                                    {formik.touched.Protocol && formik.errors.Protocol && <div className="text-red-500 text-sm">{formik.errors.Protocol}</div>}
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        name="SMTPHost"
                                                    />
                                                      {formik.touched.SMTPHost && formik.errors.SMTPHost && <div className="text-red-500 text-sm">{formik.errors.SMTPHost}</div>}
                                                </div>
                                            </div>
                                            <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        name="SMTPPort"
                                                    />
                                                     {formik.touched.SMTPPort && formik.errors.SMTPPort && <div className="text-red-500 text-sm">{formik.errors.SMTPPort}</div>}
                                                </div>
                                                <div>
                                                    ...
                                                    <input
                                                        ...
                                                        name="SenderMail"
                                                    />
                                                      {formik.touched.SenderMail && formik.errors.SenderMail && <div className="text-red-500 text-sm">{formik.errors.SenderMail}</div>}
                                                </div>
                                            </div>
                                            ...
                                            <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <select name="mailtype"  onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}  value={formik.values.mailtype}  className="form-select text-white-dark" required>
                                                        <option value="">Select Type</option>
                                                        <option value="option1">HTML1</option>
                                                        <option value="option2">HTML2</option>
                                                        <option value="option3">HTML3</option>
                                                    </select>
                                                    {formik.touched.mailtype && formik.errors.mailtype && <div className="text-red-500 text-sm">{formik.errors.mailtype}</div>}
                                                </div>
                                            </div>
