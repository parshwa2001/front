                                ...
                                {filteredItems.map((contact: any) => {
                                    return (
                                        <tr key={contact.id}>
                                            ...
                                            <td className="whitespace-nowrap">{contact.user_id}</td>
                                            <td className="whitespace-nowrap">{contact.username}</td>
                                            <td className="whitespace-nowrap">{contact.role}</td>
                                            <td className="whitespace-nowrap">{contact.createPermission ? 'yes' : 'no'}</td>
                                            <td className="whitespace-nowrap">{contact.readPermission ? 'yes' : 'no'}</td>
                                            <td className="whitespace-nowrap">{contact.editPermission ? 'yes' : 'no'}</td>
                                            <td className="whitespace-nowrap">{contact.deletePermission ? 'yes' : 'no'}</td>
                                            <td>
