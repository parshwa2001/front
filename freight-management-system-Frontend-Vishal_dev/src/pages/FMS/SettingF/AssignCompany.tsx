    ...
    return (
        <div>
            <div className="flex items-center justify-between flex-wrap gap-4">
                <h2 className="text-xl"> Assign Company</h2>
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.client ? 'Edit Contact' : 'Add Assign Company'}
                                    </div>
                                    <div className="p-5">
                                        <form onSubmit={formik.handleSubmit}>
                                            <div className="grid mt-4 grid-cols-1 sm:grid-cols-2 gap-4">
                                                <div>
                                                    ...
                                                    {formik.touched.user && formik.errors.user && <div className="text-red-500 text-sm">{formik.errors.user}</div>}
                                                </div>
                                                <div>
                                                    <label htmlFor="ctnSelect2">Select Company</label>
                                                    <select id="ctnSelect1" name="company" onChange={formik.handleChange}
                                                        onBlur={formik.handleBlur}
                                                        value={formik.values.company} className="form-select text-white-dark" required>
                                                        <option>Select Company</option>
                                                        <option>1</option>
                                                        <option>2</option>
                                                        <option>3</option>
                                                    </select>
                                                    {formik.touched.company && formik.errors.company && <div className="text-red-500 text-sm">{formik.errors.company}</div>}
                                                </div>
                                            </div>
                                            ...
                                            {!viewContactModal && (
                                                <div className="flex justify-end items-center mt-8">
                                                    ...
                                                    <button type="submit" className="btn btn-primary ltr:ml-4 rtl:mr-4" >
                                                        {params.client_id ? 'Update' : 'Assign'}
                                                    </button>
                                                </div>
                                            )}
