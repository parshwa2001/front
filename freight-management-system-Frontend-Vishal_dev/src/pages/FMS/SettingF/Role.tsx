...
const Role = () => {
    ...
    const validationSchema = Yup.object().shape({
        rollname: Yup.string().required('Roll Name is required'),
                            ...
                            >
                                <Dialog.Panel className="panel border-0 p-0 rounded-lg overflow-hidden w-full max-w-lg text-black dark:text-white-dark">
                                    ...
                                    <div className="text-lg font-medium bg-[#fbfbfb] dark:bg-[#121c2c] ltr:pl-5 rtl:pr-5 py-3 ltr:pr-[50px] rtl:pl-[50px]">
                                        {params.client ? 'Edit Role' : 'Add Role'}
                                    </div>
                                    <div className="p-5">
                                        <form onSubmit={formik.handleSubmit}>
                                            <div>
                                                ...
                                                <input
                                                    ...
                                                    value={formik.values.rollname}
                                                    required
                                                />
                                                 {formik.touched.rollname && formik.errors.rollname && <div className="text-red-500 text-sm">{formik.errors.rollname}</div>}
                                            </div>
